                ...
                <div class="p-6">
                    <form action="{{ route('admin.products.update', $product) }}" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            @if($product->image)
                                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Current image: <img
                                        src="{{ asset('storage/' . $product->image) }}" alt="Current"
                                        class="w-16 h-16 object-cover inline-block rounded"></p>
                            @endif
